    ...
    <View className="flex-row justify-between items-center mt-2">
      <View className="flex-row gap-3">
        <TouchableOpacity className="flex-row items-center p-1.5" onPress={onLike}>
          ...
          />
          <Text 
            className={`text-[13px] font-semibold ml-1.5 ${comment.is_liked_by_user ? 'text-status-error' : 'text-text-lightSecondary dark:text-text-darkSecondary'}`}
          >
        ...
        <TouchableOpacity className="flex-row items-center p-1.5" onPress={onDislike}>
          ...
          />
          <Text 
            className={`text-[13px] font-semibold ml-1.5 ${comment.is_disliked_by_user ? 'text-brand-primary' : 'text-text-lightSecondary dark:text-text-darkSecondary'}`}
          >
